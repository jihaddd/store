...
{{-- <script lang="javascript" defer src="js/zy.js"></script> --}}
			...
			<div class="header-cart-content flex-w js-pscroll">
				...
				<div class="w-full">
					...
					<div class="header-cart-buttons flex-w w-full">
						<a href="{{ url('cartshop') }}" class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-r-8 m-b-10">
							عرض سلة المشتريات
						</a>
					</div>
				</div>
			...
			<div class="row">
					      ...
					      <div class="p-l-25 p-r-30 p-lr-0-lg">
                           ...
                           @foreach ($or as $item)
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb={{"../../upload/".$item->image}}>
									<div class="wrap-pic-w pos-relative">
										<img src={{"../../../upload/".$item->image}} alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href={{"../../upload/".$item->image}}>
				...
				<div class="col-md-6 col-lg-5 p-b-30">
					<div class="p-r-50 p-t-5 p-lr-0-lg">
						<h4 class="mtext-105 cl2 js-name-b2 p-b-14">
							{{$item->name}}
						</h4>
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<a  data-id="{{$item->id}}"  data-itemImage="{{"upload/".$item->image}}" data-itemname="{{$item->name}}"  data-itemprice="{{$item->price}}" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04 semer  js-addwish-b2">
										أضف إلى العربة
									   </a>
							...
							<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
								...
								<div class="block2" style="background: white;">
									<div class="block2-pic hov-img0">
										...
										<a href="{{"/viewproduct/".$x->id."/".$x->id_section}}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04">
											عرض المنتج
										 </a>
									</div>
