		...
		<div class="sidebar flex-col-l p-t-22 p-b-25">
			...
			<div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
				<ul class="sidebar-link w-full">
					...
					<li class="p-b-13">
						<a href="/hostory/{{$idd}}" class="stext-102 cl2 hov-cl1 trans-04">
							سجل الطلبات
						</a>
					</li>
					<li class="p-b-13">
					      ...
					      <div class="p-l-25 p-r-30 p-lr-0-lg">
					       <div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb={{"../../upload/".$products->image}}>
									<div class="wrap-pic-w pos-relative">
										<img src={{"../../upload/".$products->image}} alt="IMG-PRODUCT">

										<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href={{"../../upload/".$products->image}}>
						...
						<div class="p-t-33">
							...
							<div class="flex-w flex-r-m p-b-10">
								<div class="size-204 flex-w flex-m respon6-next">
									...
									<a  data-id="{{$products->id}}"  data-itemImage="{{"upload/".$products->image}}" data-itemname="{{$products->name}}"  data-itemprice="{{$products->price}}" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04 semer  js-addwish-b2">
										أضف إلى العربة
									   </a>
